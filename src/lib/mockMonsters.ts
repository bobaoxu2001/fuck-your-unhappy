...
const monsters: MonsterData[] = [
  {
    ...
    crime: "Turning tiny asks into tribunals",
    toxicSkill: "Weaponized calendar invites",
    weakness: "Being ignored",
    finalRoast: "Your urgency has been declined with prejudice.",
    diagnosis: "Stage four reply-all poisoning",
    battleIntro: "Memo Menace slides into the arena holding a calendar invite nobody asked for.",
  ...
  },
  {
    ...
    crime: "Making maybe feel like meteor strike",
    toxicSkill: "Worst-case karaoke",
    weakness: "Touching grass",
    finalRoast: "The imaginary emergency has been returned unopened.",
    diagnosis: "Premium subscription to hypotheticals",
  ...
  },
  {
    ...
    crime: "Escalating a delay into warfare",
    toxicSkill: "Volume-based reasoning",
    weakness: "Counting to ten",
    finalRoast: "Your temper got buffered and deleted.",
    diagnosis: "Untreated loading-spinner fury",
  ...
  },
  {
    ...
    crime: "Putting one thought on infinite replay",
    toxicSkill: "Mental tab duplication",
    weakness: "Living in the moment",
    finalRoast: "All 97 imaginary tabs have crashed.",
    diagnosis: "Chronic what-if tab hoarding",
  ...
  },
  {
    ...
    crime: "Leaving closure on airplane mode",
    toxicSkill: "Strategic disappearing dots",
    weakness: "Direct communication",
    finalRoast: "Even your excuses have low battery.",
    diagnosis: "Advanced emotional Wi-Fi dropout",
  ...
  },
  {
    ...
    crime: "Turning inconvenience into opera",
    toxicSkill: "Cinematic victim lighting",
    weakness: "Perspective",
    finalRoast: "The spotlight has filed a restraining order.",
    diagnosis: "Main-character weather event",
  ...
  },
  {
    ...
    crime: "Calling collapse a workflow",
    toxicSkill: "Inbox-powered soul drain",
    weakness: "A single vacation day",
    finalRoast: "Your grindset has been placed on bed rest.",
    diagnosis: "Severe spreadsheet smoke inhalation",
...
export function generateSafeFallbackMonster(): MonsterData {
  return {
    ...
    crime: "Making everything feel too heavy",
    toxicSkill: "Fog machine of dread",
    weakness: "One small next step",
    finalRoast: "You are now a decorative mist.",
    diagnosis: "Temporary overwhelm cloud cover",
