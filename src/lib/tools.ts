...
export const TOOLS: readonly ToolConfig[] = [
  ...
  },
  {
    ...
    hitTexts: ["BONK!", "CRUSH!", "CORPORATE DEMOLITION!", "SMASH!", "OBLITERATE!", "FLATTEN!"],
    comboTexts: ["HAMMER TIME!", "TOTAL DEMOLITION!", "GROUND POUND!"],
    color: "#7C3AED",
  },
  {
    id: "chicken",
  ...
  },
  {
    ...
    label: "Keyboard",
    emoji: "⌨️",
    feeling: "office rage / digital destruction",
    hitTexts: ["CTRL+ALT+DESTROY!", "KEYBOARD RAGE!", "TYPING VIOLENCE!", "KEY SMASH!", "ENTER STRIKE!", "CAPS LOCK!"],
