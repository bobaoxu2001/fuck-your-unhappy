  ...
  return (
    <section className="relative overflow-hidden rounded-[1.7rem] border-[3px] border-brand-ink bg-brand-purple-deep text-white shadow-[7px_7px_0_#17140f]">
      ...
      <div className="relative grid grid-cols-[104px_1fr] items-center gap-3 p-3.5 sm:grid-cols-[124px_1fr]">
        <div
          className="relative flex aspect-square items-center justify-center overflow-hidden rounded-[1.25rem] border-2 border-white/20"
          style={{ backgroundColor: `${boss.monster.color}33` }}
        >
          <span aria-hidden className="text-[3.25rem] leading-none drop-shadow-[0_4px_0_rgba(0,0,0,0.25)] sm:text-[4rem]">
            {boss.monster.emoji}
          </span>
        ...
        <div className="min-w-0 text-left">
          ...
          <h3 className="mt-1 break-words font-display text-[1.85rem] leading-[0.9] tracking-wide sm:text-4xl">{boss.monster.name}</h3>
